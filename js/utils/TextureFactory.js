export class TextureFactory {
  ...
  static createHazardTextures(scene){
    ...
    if(!scene.textures.exists('hazard-root-thorns')){const g=scene.add.graphics();g.fillStyle(0x3b2728,1).fillRect(0,20,62,8);g.fillStyle(0x6e4438,1);for(let x=1;x<61;x+=10){g.fillTriangle(x,21,x+6,1+(x%4),x+12,21);g.fillStyle(0xb94877,1).fillCircle(x+6,17,2);g.fillStyle(0x6e4438,1);}g.fillStyle(0x9d6c48,1).fillRect(4,22,54,3);g.generateTexture('hazard-root-thorns',62,29);g.destroy();}
