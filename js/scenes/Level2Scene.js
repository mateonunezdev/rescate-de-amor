...
export default class Level2Scene extends BaseLevelScene {
  constructor(){ super('Level2Scene',{
    ...
    enemies:[{x:530,y:610,type:'pigeon',minX:430,maxX:730,speed:105,health:2},{x:1100,y:620,type:'broken',minX:980,maxX:1350,speed:85,health:3},{x:1740,y:280,type:'magic',minX:1600,maxX:2000,speed:95,health:3},{x:2390,y:620,type:'pigeon',minX:2200,maxX:2650,speed:115,health:3}],
    ...
    checkpoint:1700,checkpoints:[900,1800,2650],required:['card2'],unlock:3,next:'Level3Scene',exitLabel:'CASTILLO\nDE LA REINA'
  }); }
}
