...
export default class Level3Scene extends BaseLevelScene {
  constructor(){ super('Level3Scene',{
    ...
    enemies:[{x:550,y:610,type:'guard',minX:450,maxX:780,speed:75,health:4},{x:1160,y:620,type:'broken',minX:1020,maxX:1410,speed:100,health:3},{x:1780,y:280,type:'magic',minX:1650,maxX:2060,speed:110,health:4},{x:2380,y:610,type:'guard',minX:2250,maxX:2640,speed:90,health:4},{x:2820,y:300,type:'guard',minX:2740,maxX:2940,speed:105,health:8}],
