...
import WorldBuilder from '../world/WorldBuilder.js?v=20260901-structural-support-fix-02';
...
export default class BaseLevelScene extends Phaser.Scene {
  ...
  update(time,delta){
    if(!this.player||this.paused||this.gameOver)return;this.player.update(time,delta);this.updateNarrativeMoment();if(this.scene.key==='Level1Scene')this.updateLevel1Reactivity();
